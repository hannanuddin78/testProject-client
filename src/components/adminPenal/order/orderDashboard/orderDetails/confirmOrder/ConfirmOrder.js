...
const ConfirmOrder = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://ancient-bayou-19368.herokuapp.com/allOrders", {
      method: "GET",
      headers: {
            ...
            <Row>
              <Col md={12}>
                <table className="table table-borderless">
                  ...
                  {confirmOrders.map((allOrder, index) => (
                    <Confirm allOrders={allOrder} index={index} key={allOrder._id} />
                  ))}
                </table>
              </Col>
            </Row>
